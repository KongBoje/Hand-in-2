...
var calcu = require("../moduleDemo/calculator/lib/calculator.js");
...
describe('Calculator', function() {  
  ...
  describe('- Sad Path', function() {
    it('should return an empty object if arguments are not number', function() {
      var calculator = new calcu(undefined, undefined);

      expect(calculator).to.eql({});
    })

    it('Divides() - should return false when its trying to divide by 0', function() {
      var calculator = new calcu(3, 0);
